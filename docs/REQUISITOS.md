...
| RF007 | Geração de nível de confiança da classificação | O sistema deve retornar um valor de probabilidade ou confiança associado à classificação do perfil financeiro gerado. | Alta |
